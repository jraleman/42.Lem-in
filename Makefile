...
SRC_FILES  =  main.c lemin_read.c lemin_validate.c lemin_end.c lemin_print.c lemin_init.c get_ants_total.c init_ants.c init_path.c init_room.c get_room_flag.c get_room_name.c movement.c lemin_start.c
